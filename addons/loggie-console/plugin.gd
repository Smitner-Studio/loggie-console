...
const LoggieConsoleColorEditor = preload("res://addons/loggie-console/editor/loggie_console_color_editor.gd")
const LoggieConsoleColorSettings = preload("res://addons/loggie-console/resources/loggie_console_color_settings.gd")

var _project_settings_plugin: EditorPlugin
...
func _add_project_setting(name: String, default_value: Variant, type: int, documentation: String = "") -> void:
	...
	ProjectSettings.set_as_basic(name, true)  # This makes it visible in Project Settings!
